...
```powershell
## 中文转Unicode
.\native2ascii.exe -encoding utf-8 D:\WorkSpaces\GitHubWS\Java-core\docs\02.JavaAdvan
ced\conent_zh_CN.properties D:\WorkSpaces\GitHubWS\Java-core\docs\02.JavaAdvanced\conent_zh_CN_new.properties

## Unicode转中文
.\native2ascii.exe -reverse -encoding utf-8 D:\WorkSpaces\GitHubWS\Java-core\docs\02.
JavaAdvanced\content_zh_CN.properties D:\WorkSpaces\GitHubWS\Java-core\docs\02.JavaAdvanced\conent_zh_CN_new.properties
```
...
Jack，你好！你于  19-6-3 下午9:19 消费  8,888 元。
At 9:19 PM On June 3, 2019，Jack paid $8,888.00.
```
