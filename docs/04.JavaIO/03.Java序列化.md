...
![](https://raw.githubusercontent.com/hyman213/FigureBed/master/2019/06/20190609224223.png)
...
从该结果，一方面可以看出 Person 对象中任何一个字段都没有被序列化。另一方面，如果细心的话，还可以发现此次序列化过程调用了 Person 类的无参构造方法。
