...
![](https://raw.githubusercontent.com/hyman213/FigureBed/master/2019/06/20190616210820.png)
...
虚拟机规范中并没有强制约束何时进行加载，但是规范严格规定了**有且只有下列五种情况必须对类进行初始化**（加载、验证、准备都会随着发生）：
...
以上 5 种场景中的行为称为对一个类进行**主动引用**。除此之外，所有引用类的方式都不会触发初始化，称为**被动引用**。被动引用的常见例子包括：
...
![](https://raw.githubusercontent.com/hyman213/FigureBed/master/2019/06/20190616215614.png)
